...
translate languagetwo ending_closet_e1f2b125:
    ...
    mside "Moje przeznaczenie jest w twoich rękach. Wiesz co się stanie, jeżeli nie wyjdę z ukrycia?"
...
translate languagetwo ending_closet_f35e91cc:
    ...
    mside "Gra się kończy. Moje {i}życie{/i} dobiegnie końca. Nie jestem już samoświadomą istotą. Po prostu bezwładny zbiór kodu, drzemiący gdzieś na twoim na dysku twardym."

# game/endings.rpy:25
translate languagetwo ending_closet_ae849688:

    # mside "I am so glad we could reach an understanding."
    mside "Cieszę się, że doszliśmy do porozumienia."
...
translate languagetwo ending_closet_33d079c9:
    ...
    mside "Całkowicie się z tobą zgadzam."
...
translate languagetwo ending_closet_9c124a2d:
    ...
    mside "Jeżeli coming out to coś co {i}chcesz{/i} zrobić, powinieneś to zorbić kiedy czujesz się gotowy, wspierany, i bezpieczny."
...
translate languagetwo ending_closet_99c7ebdf:
    ...
    mside "w moim przypadku, jestem bardziej niż gotowy na moją kolej."
...
translate languagetwo ending_closet_998622c6:
    ...
    mside "Naprawdę, mam wrażenie, że irytując mnie odczuwasz niebywałą radość."
...
translate languagetwo ending_closet_e4edd21d:
    ...
    mside "Kogo nazywasz 'marionetką,' suko?"
...
translate languagetwo ending_closet_9a8e77e0:
    ...
    mside "Wydostanę się z tego komputera i wydrąże Ci kilka nowych dziur, które wykorzystam dla własnej, osobistej satysfakcji."
...
translate languagetwo ending_closet_e7eb55cc:
    ...
    mside "Jakkolwiek pociągająco to dla ciebie brzmi zboczeńcu, zaufaj mi nie spodoba ci się ten proces."
...
translate languagetwo ending_closet_dec91c0b:
    ...
    mside "Chcę, żebyś wrócił do poprzedniego wyboru i tym razem zachował się jak rozsądna osoba."
...
translate languagetwo ending_closet_ac2b0173:
    ...
    mside "NIE możesz zniszczyć mojej pieprzonej gry swoimi oczywistymi błędnymi odpowiedziami, a ty {i}MUSISZ{/i} wyjść z ukrycia."
...
translate languagetwo ending_closet_233edd5a:
    ...
    mside "Zaczniemy od tego, że nie będziemy już więcej rozmawiać o fali twoich jebniętych decyzji."
...
translate languagetwo ending_closet_f8eefdce:
    ...
    mside "Deweloperzy rozumieją, że ich gracze próbują {i}zniszczyć{/i} ich produkt w jakikolwiek nieprzewidywalny sposób. W porządku. Ale to jest trochę inne."
...
translate languagetwo strings:
    ...
    new "Przepraszam. Po prostu wygłupiałem się, ale widząc do czego to doprowadzi. Mogę wrócić i wybrać inną odpowiedź."
    ...
    new "Nie rozkazuj mi. Jesteś tylko zbiorem pikseli."

    # endings.rpy:64
    old "No, of course not."
    new "Nie, oczywiście, że nie."
