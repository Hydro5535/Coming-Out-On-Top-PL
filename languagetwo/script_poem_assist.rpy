# TODO: Translation updated at 2021-02-21 18:01
...
translate languagetwo amos_poem_assist_34647bdc:
    ...
    edgyside "Super! Uwielbiam pomagać strudzonym pisarzom!"
...
translate languagetwo amos_poem_assist_f04fac34:
    ...
    thought "(Linie z podobnymi motywami mają podobny styl.)"
...
translate languagetwo amos_poem_assist_bf2d0233:
    ...
    edgyside "Możesz też improwizować. Nieskrępowana ekspresja jest sercem kreatywności."
...
translate languagetwo amos_poem_assist_0d093536:
    ...
    edgyside "Nie dążysz tutaj do wiarygodności, prawda?"
...
translate languagetwo amos_poem_assist_3b37161b:
    ...
    edgyside "Spójrz na tego fajnego chłopaka z college'u, który wypowiada swoje wielkie wymyślne słowa. Czy nie jesteś po prostu {i}tak mądry{/i}? Podejrzewam, że coś nadmiernie rekompensujesz."
...
translate languagetwo amos_poem_assist_43f61055:
    ...
    edgyside "Właściwie to smutne. Nie żeby mnie to obchodziło. Po prostu czuję, że ktoś powinien ci powiedzieć, żebyś przynajmniej wiedział, dlaczego nikt cię nie lubi."
...
translate languagetwo amos_poem_assist_e8120d00:
    ...
    edgyside "Poszedłbym w stronę {i}'butt brownies'{/i}. Albo {i}'toilet loaves.'{/i}"
...
translate languagetwo amos_poem_assist_08a61e4b:
    ...
    edgyside "Nie ma nic bardziej romantycznego niż nazwanie kogoś „drzewem”. Yeesh. Następnie powiesz, że przypominają ci przystanek autobusowy?"
...
translate languagetwo amos_poem_assist_06225684:
    ...
    edgyside "{i}'Twoja ławka, na której usiadłem, aby dać odpocząć zmęczonym nogom.'{/i}"
...
translate languagetwo amos_poem_assist_dbf99415:
    ...
    edgyside "Ahhh, w końcu mamy coś wspólnego. Widzisz, ja też jestem miłośnikiem cum boxów."
...
translate languagetwo amos_poem_assist_f42763f2:
    ...
    edgyside "Dreszczyk emocji związany z robieniem czegoś tak obrzydliwego jest nieopisany. Lubię też mieć taki mroczny i brudny sekret. Brawa za to, że jesteś sobą, brachu."
...
translate languagetwo amos_poem_assist_a67a83e7:
    ...
    edgyside "Ahh, widzę, że piszesz to o swojej mamie."
...
translate languagetwo amos_poem_assist_51162c78:
    ...
    edgyside "Ooooooh, to im pokaż. CAłkowicie opryskilwe. Będziesz miał szczęście, jeśli wyjdziesz z tego miejsca żywy."
...
translate languagetwo amos_poem_assist_d523d464:
    ...
    edgyside "Co!? Co to znaczy? Ma swój własny {i}świat{/i}? Brzmi jak imponujący gość."
...
translate languagetwo amos_poem_assist_bceefa8f:
    ...
    edgyside "Ciekawostka: Odbytnica to najgęstsza pod względem odżywczym część kota. To samo dotyczy większości ssaków. Więc nie bój się polizać raz lub dwa."
...
translate languagetwo amos_poem_assist_54aa85b4:
    ...
    edgyside "WHOA WHOA WHOA! Nie żeby jakakolwiek dalsza bojkot społeczny wpłynął jakkoliwek na twoje życie, ale zapraszasz na sprawę kryminalną tak pisząc."
...
translate languagetwo amos_poem_assist_af590c09:
    ...
    edgyside "Wiesz, jestem dość twardy, jeśli tego szukasz. Próbowałeś kiedyś starej sztuczki {i}ruler up the bunghole{/i}? To rozwali twój umysł."
...
translate languagetwo amos_poem_assist_63202ecb:
    ...
    edgyside "Uh huh. Nie ma lepszego sposobu na zdobycie tłumu niż powiedzenie im, żeby się zabili."
...
translate languagetwo amos_poem_assist_22c792e0:
    ...
    edgyside "Ale co z twoimi ustami? To tan powstają twoje kłamstwa, prawda? Ty sprośny mały kłamco! Nikogo nie oszukasz."
...
translate languagetwo amos_poem_assist_b5ccc835:
    ...
    edgyside "Mało prawdopodobne. Koty są generalnie anarchistami, ale niektórych lepiej byłoby sklasyfikować jako nihilistów. Pamiętaj, że dokładność ma ogromne znaczenie podczas tworzenia wiersza."
...
translate languagetwo amos_poem_assist_02261d2a:
    ...
    edgyside "Ahh, jakie to słodkie. Idziesz w romantyczną stronę, eh?"
...
translate languagetwo amos_poem_assist_960f4df0:
    ...
    edgyside "Czy twoja rodzina została zamordowana przez poetę czy coś? Szczerze mówiąc, ktoś tu ma problem."
...
translate languagetwo amos_poem_assist_b7129eb9:
    ...
    edgyside "Poważne pytanie — kto tak robi?"
...
translate languagetwo amos_poem_assist_64f94475:
    ...
    edgyside "A co z kupą? I podatkami? I śmiercią? Wygląda na to, że trochę owijasz w bawełnę, huh?"
...
translate languagetwo amos_poem_assist_9d6bc8f1:
    ...
    edgyside "Chciałbym móc wyskoczyć z tego komputera i rzucić okiem na {i}twoje{/i} włosy łonowe, kochanie. Ty też masz ładne małe usta. Trochę mnie to ciekawi."
...
translate languagetwo amos_poem_assist_80f330d3:
    ...
    edgyside "Mocny koniec. 'Lyrical nuts' to czysty geniusz. Całkowicie inspirujące. Dobra robota."
...
translate languagetwo amos_poem_assist_9e98eeb3:
    ...
    edgyside "Nie tak prosto z mostu. Nasza relacja jest zbyt niedojrzała na wyznawanie miłości, nie wspominając o groteskowej sentymentalności. Słaba forma, nawet jak na ciebie."
...
translate languagetwo amos_poem_assist_59542612:
    ...
    edgyside "{i}Definitywnie{/i} powiedziałeś to na swój sposób. Cholerny dziwak. Czy jest coś takiego jak policja poetycka? Bo buszę do nich zadzwonić, jeżeli istnieją."
...
translate languagetwo amos_poem_assist_71130b49:
    ...
    edgyside "Cholera. Zrobiłeś to. Napisałeś wiersz. Jak się z tym czujesz?"
...
translate languagetwo amos_poem_assist_15f12643:
    ...
    mside "Całkiem dobre. Jednak to ty jesteś ekspertem. Co o tym myślisz?"
...
translate languagetwo amos_poem_assist_0f6985ec:
    ...
    edgyside "Ja skończyłbym to tutaj, [lastname!t]. To dziwne. Wręcz ostraszające. To tak jakbyś wybuchł śmiechem na czimś pogrzebie. Uwierz mi to nic dobrego."
...
translate languagetwo amos_poem_assist_829b8f76:
    ...
    edgyside "Ale jest oryginalny i wiele można mówić o oryginalności, prawda?"
...
translate languagetwo amos_poem_assist_a534486f:
    ...
    edgyside "To jest gorące. Piekielnie gorące. Żałuję, że nie mam rąk, by móc pocierać całe dwanaście cali mojego twardego, drewnianego ciała."
...
translate languagetwo amos_poem_assist_3aebb9e1:
    ...
    edgyside "Myślisz, że mógłbyś przynajmniej zdjąć koszulę? Dasz mi mały pokaz? Słodki mały pokaz?"

# game/script_poem_assist.rpy:870
translate languagetwo amos_poem_assist_5560db79:

    # mside "I have to go. Thanks for the help!"
    mside "Muszę już iść. Dzięki za pomoc!"
...
translate languagetwo amos_poem_assist_17f711df:
    ...
    edgyside "No weź. Rulers też mają swoje potrzeby! Pokaż mi tylko sutek. Jedn mały sutek."
...
translate languagetwo amos_poem_assist_e27e3d97:
    ...
    edgyside "To jest inspirujące. Prawie idealne. Wziąłeś swóją moszne i całkowicie ja opanowałeś."
...
translate languagetwo amos_poem_assist_f1f4705d:
    ...
    edgyside "Naprawdę połóż im drewno, jak mówią. Uderzyłem ich prosto w kostki, mówiąc metaforycznie."
...
translate languagetwo amos_poem_assist_b44891c4:
    ...
    edgyside "Wiesz - to jest piśmienne, przemyślane. Nawet piękne miejscami. Jednak nie do końca w moim guście. Podałbym ci solidną 3.'"
...
translate languagetwo amos_poem_assist_1fbbbe5b:
    ...
    edgyside "Oh słoneczko, czy zraniłem uczucia wrażliwego poety? Chcesz chusteczkę? Czy też zamierzasz się pociąć?"

# game/script_poem_assist.rpy:897
translate languagetwo amos_poem_assist_c4538441:

    # mside "Forget that I asked."
    mside "Zapomnij, że pytałem."
...
translate languagetwo amos_poem_assist_28bcc295:
    ...
    edgyside "Moje ty biedactwo. Przepraszam za moje bezmyślne słowa. Powinienem był zdać sobie sprawę, że początkujący młody twórca literatury potrzebuje zachęty i troski."
